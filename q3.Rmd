...
##### (b) Construct a 95\% confidence interval for the population Kendull's Tau using the data in `data.csv`.
...
Use this fact to construct a confidence interval for $\rho$ using the result from part (b).
